...
const quizTypes = [
    {
        ...
        icon: <BookOpenIcon className="flex-shrink-0" size={18} aria-hidden="true"/>,
    ...
    },
    {
        ...
        icon: <FaStopwatch className="flex-shrink-0" size={18} aria-hidden="true"/>,
    ...
    },
    {
        ...
        icon: <ClipboardListIcon className="flex-shrink-0" size={18} aria-hidden="true"/>,
