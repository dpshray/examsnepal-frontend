                ...
                <div className="grid gap-4">
                  {[
                    ...
                    { term: "Service", definition: "refers to the Website." },
                    {
                      term: "Website",
                      definition:
                        "refers to examsnepal, accessible from https://www.examsnepal.com/",
                    },
                    {
                      term: "You",
                      definition:
              ...
              <section id="collecting" className="mb-12 scroll-mt-24">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
                  ...
                  <p className="text-green-800 mb-4">
                    ...
                    and may include information such as Your Device&apos;s
                ...
                <div className="bg-rose-50 border border-rose-200 rounded-lg p-6 mb-6">
                  <p className="text-rose-800">
                    When You report content or block another user, We collect
                    information related to that action — such as the reported
                    content, the reporting user, the reported user, and the
                    timestamp — in order to review reports, enforce our content
                    policies, and maintain a safe environment on the Service.
                  </p>
                </div>
              </section>
