      ...
      <div className="container max-w-7xl mx-auto py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-6">
            ...
            Service. Your access and use of the Service is conditioned on your
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 md:p-12">
              ...
              <div className="prose prose-slate max-w-none mb-12">
                <p className="text-lg text-slate-700 leading-relaxed">
                  ...
                  Conditions&quot;) govern Your relationship with Exams Nepal
                  website (the &quot;Service&quot;) operated by Exams Nepal Pvt.
                  Ltd (&quot;Us&quot;, &quot;We&quot;, or &quot;Our&quot;).
                </p>
                <p className="text-lg text-slate-700 leading-relaxed">
                  These Terms and Conditions outline the rules and regulations
                  for the use of Exams Nepal Pvt. Ltd&apos;s Website, located at{" "}
                  {""}
                  <Link
                  ...
                  and conditions. Do not continue to use Exams Nepal if you do
                ...
                <div className="grid gap-4">
                  {[
                    ...
                    },
                    {
                      term: "Website",
                      definition:
                        "refers to Exams Nepal, accessible from https://www.examsnepal.com/",
                    },
                    {
                      term: "You",
                      definition:
                    ...
                    <div
                      key={index}
                      className="bg-slate-50 rounded-lg p-4 border-l-4 border-green-500"
                    >
              ...
              <section id="user-content" className="mb-12 scroll-mt-24">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
                  <p className="text-orange-800 mb-4">
                    The Service allows users to post questions, answers,
                    comments, and other content (&quot;User Content&quot;). By
                    posting User Content, You agree not to post content that is
                    unlawful, defamatory, obscene, harassing, hateful,
                    threatening, or otherwise objectionable.
                  </p>
                  <p className="text-orange-800 mb-4">
                    We reserve the right, but do not assume the obligation, to
                    review, monitor, and remove User Content that violates these
                    Terms. Users may report objectionable content through the
                    reporting feature in the Service. We aim to review and act
                    on reports within 24 hours, which may include removing the
                    content and/or terminating the account of the user
                    responsible.
                  </p>
                  <p className="text-orange-800 mb-4">
                    Users may also block other users, which will prevent that
                    user&apos;s content from appearing in their feed.
                  </p>
                  <p className="text-orange-800">
                    Repeated or severe violations of this policy may result in
              ...
              <div className="border-t border-slate-200 pt-8 mt-12">
                <div className="text-center text-slate-500">
                  <p className="mb-2">
                    © 2025 Exams Nepal Pvt. Ltd. All rights reserved.
                  </p>
                  <p className="text-sm">
                    These terms and conditions are effective as of August 25,
                    2025
                  </p>
                </div>
              </div>
