        ...
        {!isLoading && isLoggedOut && (
          <div className="flex flex-col items-center justify-center w-full max-w-md p-8 rounded-3xl bg-white border border-gray-300 shadow-lg text-center">
            ...
            <p className="text-gray-600 mb-6">
              To see available subscription plans and pricing, please log in to
              your account.
            </p>
            <Link
              href="/login"
                ...
                <div>
                  ...
                  {activePromoId === plan.subscription_type_id && (
                    <div className="mt-4 space-y-3">
                      ...
                      >
                        {promoApplyingId === plan.subscription_type_id
                          ? "Applying..."
                          : "Apply Coupon"}
                      </Button>
...
export function AnalyticsCard({
  ...
  return (
    <div className="p-2  px-4 flex flex-col justify-between gap-4 h-auto rounded-xl shadow-sm border-white">
      <h4 className="text-muted-foreground font-medium font-poppins text-sm ">
        Total {title} test
      </h4>
    ...
    <div className="w-full">
      <div className="relative flex flex-col gap-2 p-4 rounded-xl shadow-sm overflow-hidden bg-white">
        ...
        <div className="flex justify-start items-center">
          ...
          <span className="text-sm text-gray-500 ml-1 mr-4">
            {viewCount} views
          </span>
          <Button
            size="sm"
            variant="link"
            onClick={() => router.push(`/student/dashboard/${replyId}`)}
          >
...
export default function RepliesCardSkeleton() {
  return (
    <div className="w-full flex-1">
      <div className="relative flex flex-col gap-2 p-4 rounded-xl shadow-sm overflow-hidden border border-gray-200 bg-white">
